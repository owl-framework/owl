...
PHP_METHOD(Owl_Http_Request, getPath) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, 5);
	ZEPHIR_RETURN_CALL_FUNCTION("parse_url", NULL, 18, _0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Owl_Http_Request, createFromGlobals) {
	...
	ZEPHIR_INIT_VAR(_0);
	array_init(_0);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 19, _GET, _POST, _SERVER, _0, _FILES, _COOKIE);
	zephir_check_call_status();
	RETURN_MM();
