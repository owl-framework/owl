...
ZEND_BEGIN_ARG_INFO_EX(arginfo_owl_http_requestinterface_getparam, 0, 0, 1)
	ZEND_ARG_INFO(0, key)
...
ZEPHIR_INIT_FUNCS(owl_http_requestinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Owl_Http_RequestInterface, getPath, NULL)
	PHP_ABSTRACT_ME(Owl_Http_RequestInterface, getParam, arginfo_owl_http_requestinterface_getparam)
