...
ZEPHIR_INIT_CLASS(Owl_DBAL_Driver_MySQL) {
	...
	ZEPHIR_REGISTER_CLASS(Owl\\DBAL\\Driver, MySQL, owl, dbal_driver_mysql, owl_dbal_driver_mysql_method_entry, 0);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("eventsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("dsn"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("username"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("password"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("driverOptions"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_mysql_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(owl_dbal_driver_mysql_ce TSRMLS_CC, 1, owl_dbal_driver_driverinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Owl_DBAL_Driver_MySQL, connect) {
	...
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 11, _2, _3, _4, _5);
	zephir_check_call_status();
