...
ZEPHIR_INIT_CLASS(Owl_DBAL_Driver_AbstractPdoAdapter) {
	...
	ZEPHIR_REGISTER_CLASS(Owl\\DBAL\\Driver, AbstractPdoAdapter, owl, dbal_driver_abstractpdoadapter, owl_dbal_driver_abstractpdoadapter_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("eventsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("dsn"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("username"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("password"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("driverOptions"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(owl_dbal_driver_abstractpdoadapter_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(owl_dbal_driver_abstractpdoadapter_ce TSRMLS_CC, 1, owl_dbal_driver_driverinterface_ce);
	return SUCCESS;
