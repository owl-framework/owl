...
zend_class_entry *owl_filter_filterinterface_ce;
...
zend_class_entry *owl_di_servicedefinitioninterface_ce;
zend_class_entry *owl_dispatcherinterface_ce;
zend_class_entry *owl_http_requestinterface_ce;
zend_class_entry *owl_mvc_viewinterface_ce;
...
zend_class_entry *owl_filter_abstractfilter_ce;
zend_class_entry *owl_log_abstractwriter_ce;
zend_class_entry *owl_dbal_driver_abstractpdo_ce;
...
zend_class_entry *owl_di_servicedefinition_ce;
...
static PHP_MINIT_FUNCTION(owl)
{
	...
	ZEPHIR_INIT(Owl_Filter_FilterInterface);
	...
	ZEPHIR_INIT(Owl_Di_ServiceDefinitionInterface);
	ZEPHIR_INIT(Owl_DispatcherInterface);
	ZEPHIR_INIT(Owl_Http_RequestInterface);
	ZEPHIR_INIT(Owl_Mvc_ViewInterface);
	...
	ZEPHIR_INIT(Owl_Filter_AbstractFilter);
	ZEPHIR_INIT(Owl_Log_AbstractWriter);
	ZEPHIR_INIT(Owl_DBAL_Driver_AbstractPdo);
	...
	ZEPHIR_INIT(Owl_Di_ServiceDefinition);
